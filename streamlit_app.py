...
st.markdown("Here we can see the dataframe created for this app.")
...
dataframe = dataframe[(dataframe["Price"] <= 100) & ( (dataframe["Price"] > 0) | (dataframe["Meters from chosen location"] == 0))]
